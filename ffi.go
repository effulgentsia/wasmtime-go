...
// #cgo linux,amd64,!min LDFLAGS:-L${SRCDIR}/build/linux-x86_64
// #cgo linux,amd64,min LDFLAGS:-L${SRCDIR}/build/linux-x86_64-min
// #cgo linux,arm64,!min LDFLAGS:-L${SRCDIR}/build/linux-aarch64
// #cgo linux,arm64,min LDFLAGS:-L${SRCDIR}/build/linux-aarch64-min
// #cgo darwin,amd64,!min LDFLAGS:-L${SRCDIR}/build/macos-x86_64
// #cgo darwin,amd64,min LDFLAGS:-L${SRCDIR}/build/macos-x86_64-min
// #cgo darwin,arm64,!min LDFLAGS:-L${SRCDIR}/build/macos-aarch64
// #cgo darwin,arm64,min LDFLAGS:-L${SRCDIR}/build/macos-aarch64-min
// #cgo windows,amd64,!min LDFLAGS:-L${SRCDIR}/build/windows-x86_64
// #cgo windows,amd64,min LDFLAGS:-L${SRCDIR}/build/windows-x86_64-min
// #include <wasm.h>
import "C"
import (
	"runtime"
